...
* [Skiff Mail](https://github.com/skiff-org/skiff-apps/) - End-to-end encrypted, privacy-first workspace with email, notes, calendar, and drive apps. Works on macOS, Windows, iOS, Android, and web.
