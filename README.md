...
* [react-native-wifi-p2p ★55](https://github.com/kirillzyusko/react-native-wifi-p2p) - Library that provide access for working with wi-fi direct (p2p) module in android
